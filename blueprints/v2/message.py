...
class MessageAPI:
    ...
    def message_get(self, request, thread_type, thread_id, message_id):
        db = request.ctx.db
    ...
    def message_delete(self, request, thread_type, thread_id, message_id):
        db = request.ctx.db
    ...
    @openapi.response(400, {"application/json" : ops.MissingRequiredJson})
    @openapi.response(401, {"application/json" : ops.Unauthorized})
    async def message_create(self, request, thread_type, thread_id):
        db = request.ctx.db
    ...
    @openapi.response(401, {"application/json" : ops.Unauthorized})
    @openapi.response(404, {"application/json" : ops.Void})
    def message_mass_get(self, request, thread_type, thread_id):
        db = request.ctx.db
